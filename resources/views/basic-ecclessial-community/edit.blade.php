...
<section class="content-header">
    ...
    @endif
                        ...
                        <form role="form" id="update-employee33" action="{{ route('manage-community-update') }}" name="add-user"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="center_id" id="center_id">
                                            ...
                                            <?php $selected = $info->center_id == $centrale->id ? "selected":""?>
                                        ...
                                        <div class="col-md-10 mb-3">
                                            <div class="form-group">
                                                <label for="category_name">Community name<span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="community_name"
                                                    name="community_name" value="{{ $info->community_name }}">
                                                <small
                                                    class="help-block text-danger">{{ $errors->first('community_name') }}</small>
                                            </div>
                                        </div>
