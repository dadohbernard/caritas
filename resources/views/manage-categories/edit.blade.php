...
<section class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-12">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('manage-category') }}">{{ $brVal }}</a></li>
    ...
    @endif
                        ...
                        <form role="form" id="update-employee33" action="{{ route('manage-category-update') }}" name="add-user"
                                        ...
                                        <div class="col-md-8 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="category_name"
                                                    name="category_name" value="{{ $info->category_name }}">
                                                <small
                                                    class="help-block text-danger">{{ $errors->first('category_name') }}</small>
                                            </div>
                                        </div>
