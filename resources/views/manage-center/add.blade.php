...
@section('content')
    ...
    @endif
                    <form role="form" id="add-user" action="{{ route('manage-centrales-save') }}" name="add-category"
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-group">
                                        <label for="center_name">Centrale name<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="center_name" name="center_name">
                                        <small class="text-danger">{{ $errors->first('center_name') }}</small>
                                    </div>
                                </div>
